...
/* The following instructions have to be followed BEFORE compiling the Processing code:
   ...
   2) Reboot the server.
   3) Compile the code region with cmd+enter to initialise MIDI connections and create MIDIdefs, SynthDefs and OSCdefs.
...
//////////////////////////////////////////////////////////////////////
//////
(   // Click cmd+enter here to compile the region.
//////
//////////////////////////////////////////////////////////////////////
v = s.volume;
